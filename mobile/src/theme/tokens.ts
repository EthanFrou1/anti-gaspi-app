// Copie de design/leftly/leftly-tokens.ts (livrable de la charte Leftly), avec UNE correction :
// « const dark: typeof light » ne compile pas en TypeScript strict (le « as const » de la palette
// impose au mode sombre les valeurs exactes du mode clair) ; remplacé par
// « Record<keyof typeof light, string> ». À signaler pour corriger le livrable.
// Ne rien modifier d'autre ici : mettre à jour le livrable, puis recopier. Les adaptations propres
// à l'app (thème clair / sombre, correspondances) sont dans les autres fichiers de ce dossier.
